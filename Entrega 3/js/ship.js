...
class Ship extends GameEntity {
    ...
    changeMaterialsToPhong(){
        this.children[0].material = gameMaterials.getShipPhongMaterial("blue");
        this.children[1].material = gameMaterials.getShipPhongMaterial("green");
        this.children[2].material = gameMaterials.getShipPhongMaterial("red");
        this.children[3].material = gameMaterials.getShipPhongMaterial("green");
        this.children[4].material = gameMaterials.getShipPhongMaterial("green");
        this.children[5].material = gameMaterials.getShipPhongMaterial("blue");
        this.children[6].material = gameMaterials.getShipPhongMaterial("blue");
        this.children[7].material = gameMaterials.getShipPhongMaterial("red");
        this.children[8].material = gameMaterials.getShipPhongMaterial("red");
    }
    changeMaterialsToLambert(){
        this.children[0].material = gameMaterials.getShipLambertMaterial("blue");
        this.children[1].material = gameMaterials.getShipLambertMaterial("green");
        this.children[2].material = gameMaterials.getShipLambertMaterial("red");
        this.children[3].material = gameMaterials.getShipLambertMaterial("green");
        this.children[4].material = gameMaterials.getShipLambertMaterial("green");
        this.children[5].material = gameMaterials.getShipLambertMaterial("blue");
        this.children[6].material = gameMaterials.getShipLambertMaterial("blue");
        this.children[7].material = gameMaterials.getShipLambertMaterial("red");
        this.children[8].material = gameMaterials.getShipLambertMaterial("red");
    }
    changeMaterialsToBasic(){
        this.children[0].material = gameMaterials.getShipBasicMaterial("blue");
        this.children[1].material = gameMaterials.getShipBasicMaterial("green");
        this.children[2].material = gameMaterials.getShipBasicMaterial("red");
        this.children[3].material = gameMaterials.getShipBasicMaterial("green");
        this.children[4].material = gameMaterials.getShipBasicMaterial("green");
        this.children[5].material = gameMaterials.getShipBasicMaterial("blue");
        this.children[6].material = gameMaterials.getShipBasicMaterial("blue");
        this.children[7].material = gameMaterials.getShipBasicMaterial("red");
        this.children[8].material = gameMaterials.getShipBasicMaterial("red");
    }
    // Movement methods
    ...
    addShipBody() {
        ...
        var mesh = new THREE.Mesh(geom, gameMaterials.getShipLambertMaterial("blue"));
    ...
    addShipWindow() {
        ...
        var mesh = new THREE.Mesh(geom, gameMaterials.getShipLambertMaterial("green"));
        mesh.position.set(0, 0, 0);
        this.add(mesh);
    }
    addShipCannon() {
        ...
        var mesh = new THREE.Mesh(geom, gameMaterials.getShipLambertMaterial("red"));
        mesh.position.set(0, 0, 0);
        this.add(mesh);
    }
    addShipThrusterLeft() {
